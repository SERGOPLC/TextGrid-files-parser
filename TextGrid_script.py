...
import pandas as pd
import textgrid
path = 'C:/Users/Sergey/Desktop/ben_mfa/'  # путь к TextGrid файлам. Пример: 'C:/Users/Sergey/Desktop/ben_mfa/'
...
df_ntc.to_csv('words.csv', index=False)
...
df_phones_ntc.to_csv('words_with_phones.csv', index=False)